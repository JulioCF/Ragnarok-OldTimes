...
{
	ShowInfo(CL_WHITE"RagnaMemories com eAthena, RAthena e Outros" CL_RESET"\n");
...
//	atcommand_config_read(ATCOMMAND_CONF_FILENAME);
	...
	/* 
	 * ATEN«√O BRASIL:
	 * Comentei as linhas abaixo porque n„o est„o presentes
	 * no EpisÛdio Amatsu & Kunlun.
	 * Em ordem: Inst‚ncias, Assistentes, Quest System e BG.
	 */
