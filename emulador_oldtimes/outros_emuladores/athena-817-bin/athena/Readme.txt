...
Q: I followed all the instructions then tried loading eAthena
   but it gave me an error about cygwin1.dll is not found!
   What do I do?
A: You're missing the cygwin dlls. They are easy to get from
   the internet. Asking around in our IRC chatroom will get you
   around too, but always remember - search before asking.
...
A: Drop the developers a line at the IRC chatroom. Or just post
   it in the forums. We check them out too :)
...
You can also visit out IRC chatroom and ask your questions
there.
--------------------------------------------------------------
--------------------------------------------------------------
