...
// lan_support.conf, incluido na pasta 'conf'
 e:=ArquivoCfg.Criar('conf\lan_support.conf','"conf\lan_support.conf" não encontrado');
...
// charcommand_athena.conf, incluido na pasta 'conf'
 g:=ArquivoCfg.Criar('conf\charcommand_athena.conf','"conf\charcommand_athena.conf" não encontrado');
