...
',
		...
		clif_displaymessage(fd, " 13=Campo de Treinamento  14=Prisão"); //14=Lou Yang
		//clif_displaymessage(fd, " 18=Ayothaya        19=Einbroch    20=Lighthalzen");
		//clif_displaymessage(fd, " 21=Einbech         22=Hugel");
',$atcommandc);

$atcommandc = str_replace("// 'alternative' name (3 first characters)","",$atcommandc);

$atcommandc = str_replace('} else if (strncmp(map_name, "lutie.gat", 3) == 0 || // name of the city, not name of the map (3 first characters)
			...
			town = 19;
		           ...
		           strncmp(map_name, "reichthalzen.gat", 3) == 0) {','',$atcommandc);
